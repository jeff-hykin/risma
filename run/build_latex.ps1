...
import { throttle } from 'https://esm.sh/gh/jeff-hykin/good-js@1.17.0.0/source/flattened/throttle.js'
const $$ = (...args)=>$(...args).noThrow()
// await $$`false`
// await $$`false`.text("stderr")

const latexFilePath = `${FileSystem.thisFolder}/../writing/root.tex`
